...
\par
Bla bla bla não vai passar de uma página.
\newpage
\vspace*{10pt}
...
% Para separar parágrafos utilize uma linha em branco ou \par.
\todo[inline,color=red]{Para TC2 modificar Resumo e Abstract}
\par
...
\acro{LFOT}{Transitórios oscilatórios de baixa frequência}
\acro{TW}{Transformada Wavelet}
\acro{UDP}{User Datagram Protocol}
\acro{VTCDs}{Variações de Tensão de Curta Duração}
