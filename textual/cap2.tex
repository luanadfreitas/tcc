...
\par 
% paragrafo de ligação dos conceitos de EE e QEE
...
\todo[inline,size=\small,color=red]{Correção nº11 do Prof JJ, acrescentar ref para EN E I3E}
\par
...
\section{Distúrbios Elétromagneticos}\label{qeeDis}
\todo[inline,size=\small,color=blue!60]{Nota de rodapé indicando a existencia de um glossário para termos técnicos da Elétrica}
\par 
...
\todo[inline,size=\small,color=blue!60]{Indicando o estudo direcionado para o que \cite{BAC11} trabalhou}
...
\item b(5) Cortes.
\end{itemize}
\subsection{Transitórios}\label{qeeTrans}
\par 
\todo[inline,size=\small,color=yellow]{Subsection \ref{qeeTrans} foi modificada desde a ultima versão de TC1}%
...
\subsection{Variações de tensão}\label{qeeVarTens}
\todo[inline,size=\small,color=yellow]{Antigas subsecitons variações de curta e longa tensão unidas em \ref{qeeVarTens}}%
\par
...
\subsection{Distorções da Forma de Onda e Harmônicos}
\todo[inline,size=\small,color=yellow]{Unidas as duas subsections formando uma >}
\par 
...
\subsubsection{Interharmônicos, Ruídos e Nível Corrente Contínua (CC)}\label{qeeIRNCC}
\todo[inline,size=\small,color=yellow]{Esta subsection foi criada agrupando os temas Interharmônicos, Ruídos e Nível Corrente Contínua (CC), separados possuíam curta descrição}%
\par
...
\subsubsection{Flutuações ou Oscilações de Tensão}\label{qeeFluOT}
\todo[inline,size=\small,color=yellow]{A subsection  \ref{qeeFluOT} foi criada agrupando os temas Flutuações ou Oscilações de Tensão, pelo mesmo argumento apresentado em \ref{qeeIRNCC}.}
\par
...
\begin{table}[!h]
\begin{center}
\caption{Principais causas dos fenômenos eletromagnéticos conforme recomendação \citep{IEE95}.}
\includegraphics[height=15cm]{imagens/tab1_cap2.png}
\par{\small Fonte: Adaptada pelo autor de \cite{JUN09}.}
\label{fig:tabpdistele}
\end{center}
\end{table}
\section{Quantificação de QEE (Causas, Origens e Efeitos)}\label{qeeCOE}
\par
...
\par 
\todo[inline,size=\small,color=yellow]{Reformulado o fechamento abaixo, do capítulo \ref{qeeEE}.}
