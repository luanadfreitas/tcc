...
\par
O valor eficaz ou RMS é uma das técnicas mais utilizadas para a detecção de eventos que afetam QEE %\cite{KAG09}
...
A Transformada de Fourier pode ser considerada como a soma de funções trigonométricas (senoidal e cossenoidal) ou de exponenciais complexas harmonicamente relacionadas %\cite{KAG09}
...
\subsection{Método baseado na aplicação da Transformada Wavelet}
\par
Em %\cite{KIM01} 
