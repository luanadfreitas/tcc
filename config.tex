...
% uso: \acro{sigla}{descrição} cria um acrônimo e imprime ele num
%ambiente \begin{acronym}
...
%      \ac{sigla} coloca a descrição da sigla se for sua primeira aparição
\usepackage{acronym}
...
%\usepackage[nottoc,notlof,notlot]{tocbibind} template urgfs já faz, gerar entrada duplicado no sumario
